...
function () {
  ...
  _createClass(Region, [{
    ...
    value: function render() {
      ...
      regionEl.setAttribute('word', this.data[0]);
      regionEl.setAttribute('score', this.data[1]);
      ...
      if (this.resize) {
        ...
        wordLabel.appendChild(document.createTextNode(this.data[0]));
        scoreLabel.appendChild(document.createTextNode(this.data[1]));
        regionEl.appendChild(wordLabel);
        regionEl.appendChild(scoreLabel);
