import sys
sys.path.insert(0, './VAD/lib/python')
...
def VAD_test(mode, data_len, data_dir="./VAD/sample_data", norm_dir="./VAD/norm_data", model_dir="./VAD/saved_model", is_default=1):
    ...
    # except getpot.GetoptError as err:
    #     print(str(err))
    #     sys.exit(1)

    # if len(opts) != 2:
    #     print("arguments are not enough.")
    #     print("Usage: python VAD_test.py -f [wavfile path] -m [model mode]")
    #     sys.exit(1)
    ...
    # norm_dir = "./norm_data"
    # model_dir = "./saved_model"
    # data_len, _, _ = extract_mrcg_feats(filename)
    if mode == 0:
        ...
        print(os.path.abspath('./VAD/configure/bDNN'))
        sys.path.insert(0, os.path.abspath('./VAD/configure/bDNN'))
        ...
        start_time = time()
        print(os.path.abspath('./VAD/configure/DNN'))
        sys.path.insert(0, os.path.abspath('./VAD/configure/DNN'))
        ...
        sys.path.insert(0, os.path.abspath('./VAD/configure/LSTM'))
    ...
    sio.savemat('./VAD/result/pred.mat', {'pred': pred})
    sio.savemat('./VAD/result/label.mat', {'label': label})
